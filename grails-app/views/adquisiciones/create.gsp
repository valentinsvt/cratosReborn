...
<div class="btn-toolbar toolbar">
    <div class="btn-group">
        <g:link class="btn btn-azul" action="list">
            <i class="fa fa-times"></i>
            Lista de adquisiciones
        </g:link>
        <g:if test="${ordenesCompra}">
            <g:link class="btn btn-azul" controller="ordenCompra" action="create">
                <i class="fa fa-times"></i>
...
<div id="create-adquisiciones" class="content scaffold-create" role="main">
    ...
    <div class="contenedor" style="width: 950px; height: 850px">
        ...
        %{--<span class="grupo">--}%
        <g:hiddenField name="ordenes" value="${ordenCompra ? ordenCompra.id : ''}"/>
        <input name="txtBuscarOC" type="text" value="${ordenCompra ? ordenCompra.descripcion : ''}" style="width:300px;" class="form-control"/>
        %{--</span>--}%
        </div>
        </div>
