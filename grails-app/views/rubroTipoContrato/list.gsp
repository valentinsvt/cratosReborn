...
<head>
    ...
    <title>Lista de Rubros por Contrato</title>
...
<div class="vertical-container vertical-container-list">
    <p class="css-vertical-text">Lista de Rubros por Contrato</p>
    ...
    <table class="table table-condensed table-bordered table-striped table-hover">
        ...
        <g:each in="${rubroTipoContratoInstanceList}" status="i" var="rubroTipoContratoInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}" id="${rubroTipoContratoInstance.id}">
                ...
                <td>${rubroTipoContratoInstance?.rubro}</td>
                <td>${rubroTipoContratoInstance?.porcentaje}</td>
                <td>${rubroTipoContratoInstance?.editable}</td>
                <td>${rubroTipoContratoInstance?.decimo}</td>
                <td>${rubroTipoContratoInstance?.iess}</td>
...
<elm:pagination total="${rubroTipoContratoInstanceTotal}" params="${params}"/>
%{--</div>--}%
