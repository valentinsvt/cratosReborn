...
<div class="vertical-container vertical-container-list">
    <p class="css-vertical-text">Lista de Rubros</p>
    ...
    <table class="table table-condensed table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <g:sortableColumn property="tipoRubro" title="Tipo de Rubro"/>
            ...
            <g:sortableColumn property="decimo" title="Decimo"/>

            <g:sortableColumn property="iess" title="Iess"/>
        ...
        <g:each in="${rubroInstanceList}" status="i" var="rubroInstance">
            <tr data-id="${rubroInstance.id}">
                ...
                <g:if test="${rubroInstance?.decimo == '1'}">
                    <td>${'SI'}</td>
                </g:if>
                <g:else>
                    <td>${'NO'}</td>
                ...
                <g:if test="${rubroInstance?.iess == '1'}">
                    <td>${'SI'}</td>
                </g:if>
                <g:else>
                    <td>${'NO'}</td>
                ...
                <td>
                    <a href="#" data-id="${rubroInstance.id}" class="btn btn-info btn-sm btn-show btn-ajax" title="Ver">
                        <i class="fa fa-laptop"></i>
                    </a>
                    <a href="#" data-id="${rubroInstance.id}" class="btn btn-success btn-sm btn-edit btn-ajax"
                       title="Editar">
                        <i class="fa fa-pencil"></i>
                    </a>
                    <a href="#" data-id="${rubroInstance.id}" class="btn btn-danger btn-sm btn-delete btn-ajax"
                       title="Eliminar">
...
<elm:pagination total="${rubroInstanceCount}" params="${params}"/>
