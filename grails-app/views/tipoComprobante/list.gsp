...
<html>
    ...
    <!-- botones -->
                ...
                <tbody>
                    <g:each in="${tipoComprobanteInstanceList}" status="i" var="tipoComprobanteInstance">
                        <tr data-id="${tipoComprobanteInstance.id}">
                            ...
                            <td>
                                <a href="#" data-id="${tipoComprobanteInstance.id}" class="btn btn-info btn-sm btn-show btn-ajax" title="Ver">
        ...
        <elm:pagination total="${tipoComprobanteInstanceCount}" params="${params}"/>
