    ...
    <g:else>
        <g:form class="form-horizontal" name="frmEmpresa" role="form" action="save_ajax" method="POST">
            ...
            <div class="keeptogether">
                ...
                <div class="form-group keeptogether ${hasErrors(bean: empresaInstance, field: 'canton', 'error')} ">
                    <span class="grupo">
                        <label for="canton" class="col-md-3 control-label text-info">
                            Cantón
                        </label>

                        <div class="col-md-6">
                            <g:select id="canton" name="canton.id" from="${cratos.Canton.list()}" optionKey="id" optionValue="nombre"
                                      value="${empresaInstance?.canton?.id}" class="many-to-one form-control" noSelection="['null': '']"/>
                        </div>
