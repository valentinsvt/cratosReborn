...
<html>
    ...
    <!-- botones -->
        ...
        <div class="vertical-container vertical-container-list">
            <p class="css-vertical-text">Reporte de Cuentas</p>
        ...
        <elm:pagination total="${reporteCuentaInstanceCount}" params="${params}"/>

        <script type="text/javascript">
            var id = null;
            function submitForm() {
                var $form = $("#frmReporteCuenta");
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    title   : "Alerta",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Reporte de Cuenta seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
