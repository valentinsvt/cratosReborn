...
<html>
    ...
    <!-- botones -->
            ...
            <table class="table table-condensed table-bordered table-striped table-hover">
                ...
                <tbody>
                    <g:each in="${formaDePagoInstanceList}" status="i" var="formaDePagoInstance">
                        <tr data-id="${formaDePagoInstance.id}">
                            ...
                            <td>
                                <a href="#" data-id="${formaDePagoInstance.id}" class="btn btn-info btn-sm btn-show btn-ajax" title="Ver">
        ...
        <elm:pagination total="${formaDePagoInstanceCount}" params="${params}"/>
