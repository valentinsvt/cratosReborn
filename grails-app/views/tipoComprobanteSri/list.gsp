...
<html>
    <head>
        ...
        <title>Lista de Tipo Comp. SRI</title>
    </head>
    <body>
    ...
    <!-- botones -->
        ...
        <div class="vertical-container vertical-container-list">
            <p class="css-vertical-text">Lista de Tipo Comprobante SRI</p>
            ...
            <table class="table table-condensed table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <g:sortableColumn property="secuenciales" title="Secuenciales" />
                        
                        <g:sortableColumn property="sustento" title="Sustento" />
                ...
                <tbody>
                    <g:each in="${tipoComprobanteSriInstanceList}" status="i" var="tipoComprobanteSriInstance">
                        <tr data-id="${tipoComprobanteSriInstance.id}">
                            ...
                            <td>${fieldValue(bean: tipoComprobanteSriInstance, field: "secuenciales")}</td>
                            
                            <td>${fieldValue(bean: tipoComprobanteSriInstance, field: "sustento")}</td>
                            
                            <td>
                                <a href="#" data-id="${tipoComprobanteSriInstance.id}" class="btn btn-info btn-sm btn-show btn-ajax" title="Ver">
                                    <i class="fa fa-laptop"></i>
                                </a>
                                <a href="#" data-id="${tipoComprobanteSriInstance.id}" class="btn btn-success btn-sm btn-edit btn-ajax" title="Editar">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a href="#" data-id="${tipoComprobanteSriInstance.id}" class="btn btn-danger btn-sm btn-delete btn-ajax" title="Eliminar">
